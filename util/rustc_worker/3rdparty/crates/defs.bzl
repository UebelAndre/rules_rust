...
#
#     bazel run @@//util/rustc_worker/3rdparty:crates_vendor
###############################################################################
"""
...
_CRATE_EDITIONS = {
    "util/rustc_worker": "2021",
}

_NORMAL_DEPENDENCIES = {
    "util/rustc_worker": {
        _COMMON_CONDITION: {
            "serde": Label("@rrw//:serde-1.0.219"),
            "serde_json": Label("@rrw//:serde_json-1.0.140"),
            "sha2": Label("@rrw//:sha2-0.10.9"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "rrw__block-buffer-0.10.4",
        sha256 = "3078c7629b62d3f0439517fa394996acacc5cbc91c5a20d8c658e77abd503a71",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/block-buffer/0.10.4/download"],
        strip_prefix = "block-buffer-0.10.4",
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.block-buffer-0.10.4.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__cfg-if-1.0.4",
        sha256 = "9330f8b2ff13f34540b44e946ef35111825727b38d33286ef986142615121801",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/cfg-if/1.0.4/download"],
        strip_prefix = "cfg-if-1.0.4",
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.cfg-if-1.0.4.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__cpufeatures-0.2.17",
        sha256 = "59ed5838eebb26a2bb2e58f6d5b5316989ae9d08bab10e0e6d103e656d1b0280",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/cpufeatures/0.2.17/download"],
        strip_prefix = "cpufeatures-0.2.17",
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.cpufeatures-0.2.17.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__crypto-common-0.1.7",
        ...
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.crypto-common-0.1.7.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__digest-0.10.7",
        sha256 = "9ed9a281f7bc9b7576e61468ba615a66a5c8cfdff42420a70aa82701a3b1e292",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/digest/0.10.7/download"],
        strip_prefix = "digest-0.10.7",
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.digest-0.10.7.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__generic-array-0.14.7",
        sha256 = "85649ca51fd72272d7821adaf274ad91c288277713d9c18820d8499a7ff69e9a",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/generic-array/0.14.7/download"],
        strip_prefix = "generic-array-0.14.7",
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.generic-array-0.14.7.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__itoa-1.0.18",
        ...
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.itoa-1.0.18.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__libc-0.2.186",
        ...
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.libc-0.2.186.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__memchr-2.8.1",
        ...
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.memchr-2.8.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__proc-macro2-1.0.106",
        sha256 = "8fd00f0bb2e90d81d1044c2b32617f68fcb9fa3bb7640c23e9c748e53fb30934",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/proc-macro2/1.0.106/download"],
        strip_prefix = "proc-macro2-1.0.106",
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.proc-macro2-1.0.106.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__quote-1.0.45",
        ...
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.quote-1.0.45.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__ryu-1.0.23",
        ...
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.ryu-1.0.23.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__serde-1.0.219",
        ...
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.serde-1.0.219.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__serde_derive-1.0.219",
        ...
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.serde_derive-1.0.219.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__serde_json-1.0.140",
        ...
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.serde_json-1.0.140.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__sha2-0.10.9",
        ...
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.sha2-0.10.9.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__syn-2.0.117",
        sha256 = "e665b8803e7b1d2a727f4023456bbbbe74da67099c585258af0ad9c5013b9b99",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/syn/2.0.117/download"],
        strip_prefix = "syn-2.0.117",
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.syn-2.0.117.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__typenum-1.20.0",
        ...
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.typenum-1.20.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__unicode-ident-1.0.24",
        sha256 = "e6e4313cd5fcd3dad5cafa179702e2b244f760991f45397d14d4ebf38247da75",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/unicode-ident/1.0.24/download"],
        strip_prefix = "unicode-ident-1.0.24",
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.unicode-ident-1.0.24.bazel"),
    )

    maybe(
        http_archive,
        name = "rrw__version_check-0.9.5",
        sha256 = "0b928f33d975fc6ad9f86c8f283853ad26bdd5b10b7f1542aa2fa15e2289105a",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/version_check/0.9.5/download"],
        strip_prefix = "version_check-0.9.5",
        build_file = Label("//util/rustc_worker/3rdparty/crates:BUILD.version_check-0.9.5.bazel"),
    )

    return [
        struct(repo = "rrw__serde-1.0.219", is_dev_dep = False),
        struct(repo = "rrw__serde_json-1.0.140", is_dev_dep = False),
        struct(repo = "rrw__sha2-0.10.9", is_dev_dep = False),
    ]
