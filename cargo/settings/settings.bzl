...
def experimental_replace_rlocationpath_in_env_vars():
    """A flag which updates environment variables containing rlocationpath values generated by \
    `cargo_build_script` targets with execpaths.

    This flag only has an impact with `incompatible_runfiles_cargo_manifest_dir`.
    """
    bool_flag(
        name = "experimental_replace_rlocationpath_in_env_vars",
        build_setting_default = True,
    )
