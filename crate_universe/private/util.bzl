...
def get_cargo_and_rustc(repository_ctx, host_triple):
    ...
    cargo_path = repository_ctx.path(Label("@{}//{}{}".format(cargo_repository, tool_path["cargo"], extension)))
    rustc_path = repository_ctx.path(Label("@{}//{}{}".format(rustc_repository, tool_path["rustc"], extension)))
