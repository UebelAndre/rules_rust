...
_NORMAL_DEPENDENCIES = {
    "crate_universe": {
        _COMMON_CONDITION: {
            "anyhow": Label("//:anyhow-1.0.89"),
            "camino": Label("//:camino-1.1.9"),
            "cargo-lock": Label("//:cargo-lock-10.0.1"),
            "cargo-platform": Label("//:cargo-platform-0.1.9"),
            "cargo_metadata": Label("//:cargo_metadata-0.19.1"),
            "cargo_toml": Label("//:cargo_toml-0.20.5"),
            "cfg-expr": Label("//:cfg-expr-0.17.2"),
            "clap": Label("//:clap-4.3.11"),
            "crates-index": Label("//:crates-index-3.3.0"),
            "glob": Label("//:glob-0.3.1"),
            "hex": Label("//:hex-0.4.3"),
            "itertools": Label("//:itertools-0.13.0"),
            "normpath": Label("//:normpath-1.3.0"),
            "once_cell": Label("//:once_cell-1.20.2"),
            "pathdiff": Label("//:pathdiff-0.2.3"),
            "regex": Label("//:regex-1.11.0"),
            "semver": Label("//:semver-1.0.23"),
            "serde": Label("//:serde-1.0.210"),
            "serde_json": Label("//:serde_json-1.0.129"),
            "serde_starlark": Label("//:serde_starlark-0.1.16"),
            "sha2": Label("//:sha2-0.10.8"),
            "spdx": Label("//:spdx-0.10.7"),
            "tempfile": Label("//:tempfile-3.14.0"),
            "tera": Label("//:tera-1.19.1"),
            "textwrap": Label("//:textwrap-0.16.1"),
            "toml": Label("//:toml-0.8.19"),
            "tracing": Label("//:tracing-0.1.40"),
            "tracing-subscriber": Label("//:tracing-subscriber-0.3.18"),
            "url": Label("//:url-2.5.2"),
