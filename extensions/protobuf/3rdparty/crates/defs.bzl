...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "grpc": Label("//:grpc-0.6.2"),
            "grpc-compiler": Label("//:grpc-compiler-0.6.2"),
            "log": Label("//:log-0.4.17"),
            "protobuf": Label("//:protobuf-2.8.2"),
            "protobuf-codegen": Label("//:protobuf-codegen-2.8.2"),
            "tls-api": Label("//:tls-api-0.1.22"),
            "tls-api-stub": Label("//:tls-api-stub-0.1.22"),
        },
    },
}
