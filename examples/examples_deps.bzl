...
load("@rules_rust//rust:repositories.bzl", "rust_exec_toolchain_repository", "rust_repositories", "rust_target_toolchain_repository")
...
def deps():
    ...
    # Example of `rust_exec_toolchain_repository`
    rust_exec_toolchain_repository(
        prefix = "rules_rust_example_exec",
        edition = "2018",
    ...
    # Example of `rust_target_toolchain_repository`
    rust_target_toolchain_repository(
        prefix = "rules_rust_example_target",
        triple = "x86_64-unknown-linux-gnu",
        sha256s = {
            "rust-1.46.0-x86_64-unknown-linux-gnu": "e3b98bc3440fe92817881933f9564389eccb396f5f431f33d48b979fa2fbdcf5",
            "rust-std-1.46.0-x86_64-unknown-linux-gnu": "ac04aef80423f612c0079829b504902de27a6997214eb58ab0765d02f7ec1dbc",
