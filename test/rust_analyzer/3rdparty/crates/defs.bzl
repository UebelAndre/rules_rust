...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//test/rust_analyzer/3rdparty/crates:BUILD.itoa-1.0.14.bazel"),
    )

    maybe(
        http_archive,
        name = "rtra__memchr-2.7.4",
        sha256 = "78ca9ab1a0babb1e7d5695e3530886289c18cf2f87ec19a575a0abdce112e3a3",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/memchr/2.7.4/download"],
        strip_prefix = "memchr-2.7.4",
        build_file = Label("//test/rust_analyzer/3rdparty/crates:BUILD.memchr-2.7.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/rust_analyzer/3rdparty/crates:BUILD.quote-1.0.38.bazel"),
    )

    maybe(
        http_archive,
        name = "rtra__ryu-1.0.18",
        ...
        build_file = Label("//test/rust_analyzer/3rdparty/crates:BUILD.ryu-1.0.18.bazel"),
    )

    maybe(
        http_archive,
        name = "rtra__serde-1.0.217",
        ...
        build_file = Label("//test/rust_analyzer/3rdparty/crates:BUILD.serde-1.0.217.bazel"),
    )

    maybe(
        http_archive,
        name = "rtra__serde_derive-1.0.217",
        ...
        build_file = Label("//test/rust_analyzer/3rdparty/crates:BUILD.serde_derive-1.0.217.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/rust_analyzer/3rdparty/crates:BUILD.syn-2.0.93.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/rust_analyzer/3rdparty/crates:BUILD.unicode-ident-1.0.14.bazel"),
    )
