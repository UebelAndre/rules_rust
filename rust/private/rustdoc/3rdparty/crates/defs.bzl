...
#
#     bazel run @@//rust/private/rustdoc/3rdparty:crates_vendor
###############################################################################
"""
...
_CONDITIONS = {
    ...
    "cfg(any(all(target_arch = \"arm\", target_pointer_width = \"32\"), target_arch = \"mips\", target_arch = \"powerpc\"))": ["@rules_rust//rust/platform:arm-unknown-linux-gnueabi", "@rules_rust//rust/platform:arm-unknown-linux-musleabi", "@rules_rust//rust/platform:armv7-linux-androideabi", "@rules_rust//rust/platform:armv7-unknown-linux-gnueabi", "@rules_rust//rust/platform:mips-unknown-linux-gnu", "@rules_rust//rust/platform:powerpc-unknown-linux-gnu", "@rules_rust//rust/platform:thumbv6m-none-eabi", "@rules_rust//rust/platform:thumbv7em-none-eabi", "@rules_rust//rust/platform:thumbv7em-none-eabihf", "@rules_rust//rust/platform:thumbv7m-none-eabi", "@rules_rust//rust/platform:thumbv8m.main-none-eabi", "@rules_rust//rust/platform:thumbv8m.main-none-eabihf"],
    "cfg(fuzzing)": [],
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.arbitrary-1.4.2.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__cfg-if-1.0.4",
        sha256 = "9330f8b2ff13f34540b44e946ef35111825727b38d33286ef986142615121801",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/cfg-if/1.0.4/download"],
        strip_prefix = "cfg-if-1.0.4",
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.cfg-if-1.0.4.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__crc32fast-1.5.0",
        sha256 = "9481c1c90cbf2ac953f07c8d4a58aa3945c425b7185c9154d67a65e4230da511",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/crc32fast/1.5.0/download"],
        strip_prefix = "crc32fast-1.5.0",
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.crc32fast-1.5.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__crossbeam-utils-0.8.21",
        sha256 = "d0a5c400df2834b80a4c3327b3aad3a4c4cd4de0629063962b03235697506a28",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/crossbeam-utils/0.8.21/download"],
        strip_prefix = "crossbeam-utils-0.8.21",
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.crossbeam-utils-0.8.21.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__derive_arbitrary-1.4.2",
        ...
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.derive_arbitrary-1.4.2.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__displaydoc-0.2.5",
        sha256 = "97369cbbc041bc366949bc74d34658d6cda5621039731c6310521892a3a20ae0",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/displaydoc/0.2.5/download"],
        strip_prefix = "displaydoc-0.2.5",
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.displaydoc-0.2.5.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__equivalent-1.0.2",
        sha256 = "877a4ace8713b0bcf2a4e7eec82529c029f1d0619886d18145fea96c3ffe5c0f",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/equivalent/1.0.2/download"],
        strip_prefix = "equivalent-1.0.2",
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.equivalent-1.0.2.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__hashbrown-0.17.1",
        ...
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.hashbrown-0.17.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__indexmap-2.14.0",
        ...
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.indexmap-2.14.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__memchr-2.8.0",
        ...
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.memchr-2.8.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__proc-macro2-1.0.106",
        sha256 = "8fd00f0bb2e90d81d1044c2b32617f68fcb9fa3bb7640c23e9c748e53fb30934",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/proc-macro2/1.0.106/download"],
        strip_prefix = "proc-macro2-1.0.106",
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.proc-macro2-1.0.106.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__quote-1.0.45",
        ...
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.quote-1.0.45.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__syn-2.0.117",
        sha256 = "e665b8803e7b1d2a727f4023456bbbbe74da67099c585258af0ad9c5013b9b99",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/syn/2.0.117/download"],
        strip_prefix = "syn-2.0.117",
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.syn-2.0.117.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__thiserror-2.0.18",
        ...
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.thiserror-2.0.18.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__thiserror-impl-2.0.18",
        ...
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.thiserror-impl-2.0.18.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__unicode-ident-1.0.24",
        sha256 = "e6e4313cd5fcd3dad5cafa179702e2b244f760991f45397d14d4ebf38247da75",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/unicode-ident/1.0.24/download"],
        strip_prefix = "unicode-ident-1.0.24",
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.unicode-ident-1.0.24.bazel"),
    )

    maybe(
        http_archive,
        name = "rrrd__zip-2.4.2",
        ...
        build_file = Label("//rust/private/rustdoc/3rdparty/crates:BUILD.zip-2.4.2.bazel"),
    )

    return [
        struct(repo = "rrrd__zip-2.4.2", is_dev_dep = False),
    ]
