...
load("//util/rustc_worker/3rdparty/crates:crates.bzl", _rustc_worker_crate_repositories = "crate_repositories")
...
def _internal_deps_impl(module_ctx):
    ...
    direct_deps.extend(_rustc_worker_crate_repositories())
